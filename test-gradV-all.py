...
if True:
    ...
    ppm.ppm(dVdx0module,f"dVdx0module, showing theoretical findings in module",sigfigs=7)
    ppm.ppm(dVdx0module-dVdx0auto,"difference from theory to approximation",sigfigs=2)
...
for t in range(T):
    ...
    ppm.ppm(dVdCtauto,f"dVdCtauto, showing finite differences done in script, t={t},",sigfigs=7)
    ppm.ppm(dVdCtmodule,f"dVdCtmodule, showing theoretical findings in module",sigfigs=7)
    ppm.ppm(dVdCtmodule-dVdCtauto,"difference from theory to approximation",sigfigs=2)
    ...
    ppm.ppm(dVdctauto,f"dVdctauto, showing automatic finite differences, t={t},",sigfigs=7)
    ppm.ppm(dVdctmodule,f"dVdctmodule, showing theoretical findings in module",sigfigs=7)
    ppm.ppm(dVdctmodule-dVdctauto,"difference from theory to approximation",sigfigs=2)
    ...
    ppm.ppm(dVdFtmodule,f"dVdFtmodule, showing theoretical findings in module,",sigfigs=7)
    ppm.ppm(dVdFtmodule-dVdFtauto,"difference from theory to auto-FD approximation,",sigfigs=2)
    ...
    ppm.ppm(dVdftauto,f"dVdftauto, showing automatic finite differences, t={t},",sigfigs=7)
    ppm.ppm(dVdftmodule,f"dVdftmodule, showing theoretical findings in module,",sigfigs=7)
    ppm.ppm(dVdftmodule-dVdftauto,"difference from theory to approximation,",sigfigs=2)
